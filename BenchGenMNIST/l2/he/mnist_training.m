...
layers = [imageInputLayer([28 28 1])
    convolution2dLayer(3, 3,'Stride',1,'WeightsInitializer','he', 'BiasInitializer','zeros');
    batchNormalizationLayer
    reluLayer
    averagePooling2dLayer(2,'Stride',2,'Padding',[0 0 0 1])
    flattenLayer
    fullyConnectedLayer(10, 'WeightsInitializer','he', 'BiasInitializer','zeros')
    softmaxLayer
    classificationLayer];
...
for sd = seeds
    ...
    % Save model
    save("models/model_l2_he_"+string(sd)+".mat", 'net', 'accuracy');
