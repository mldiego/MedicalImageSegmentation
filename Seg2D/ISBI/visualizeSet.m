...
subject = "02";
c = 100; % around the middle of the volume image
% load 3d data
flair   = niftiread(path2data + subject+"/flair.nii");
flair = permute(flair, [2 3 1]);
flair = flair_normalization(flair);
mask    = niftiread(path2data + subject+"/mask1.nii");
wm_mask = niftiread(path2data + subject+"/wm_mask.nii");
