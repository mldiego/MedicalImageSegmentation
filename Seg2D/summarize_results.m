...
labelTable = zeros(3, 3, 2, 3, 5); % [# variables, # models, # epsilon, # pixels, # images]
predTable  = zeros(3, 3, 2, 3, 5); % [# variables, # models, # epsilon, # pixels, # images]
nansLabel   = zeros(3, 3, 2, 3, 5); % keep track of NaN results
nansPred    = zeros(3, 3, 2, 3, 5); % keep track of NaN results
